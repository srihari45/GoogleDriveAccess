...
public class ExceptionActionControllerResolver extends SimpleMappingExceptionResolver {

	private Logger log = LogManager.getLogger(ExceptionActionControllerResolver.class);
